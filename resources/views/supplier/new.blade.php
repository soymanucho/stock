...
@section('actions')
  <a href="#" class="btn btn-success btn-disabled">Nuevo proveedor</a>
@endsection
...
@section('breadcrumbs')
  <div class="d-flex">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-item active">Nuevo proveedor</span>
    </div>
    ...
    @include('errors.errors')
      ...
      {{ method_field('post') }}
			...
			<div class="text-right">
				...
				<button type="submit" class="btn btn-success">Crear nuevo proveedor <i class="fas fa-user-plus"></i></button>
			</div>
		</form>
	</div>
</div>
