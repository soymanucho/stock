    ...
    <div class="sidebar-content">
      ...
      <div class="card mb-2">
        ...
        <div class="card-body p-0">
          <ul class="nav nav-sidebar" data-nav-type="accordion">
            <li class="nav-item">
              <a href="{!! route('brand-show') !!}" class="nav-link active"><i class="fas fa-tags"></i> Ver todas</a>
            </li>
            <li class="nav-item">
...
@section('actions')
  <a href="{!! route('brand-new') !!}" class="btn btn-success">Nueva marca</a>
@endsection
...
@section('breadcrumbs')
  <div class="d-flex">
    <div class="breadcrumb">
      ...
      <a href="" class="breadcrumb-item">Marcas</a>
