      ...
      <div class="card mb-2">
        ...
        <div class="card-body p-0">
          <ul class="nav nav-sidebar" data-nav-type="accordion">
            <li class="nav-item">
              <a href="{!! route('showInvitations') !!}" class="nav-link"><i class="icon-list3"></i> Listar invitaciones</a>
            </li>
            <li class="nav-item">
              <a href="{!! route('requestInvitation') !!}" class="nav-link"><i class="icon-user-plus"></i> Nueva invitación</a>
            </li>
          </ul>
        </div>
      </div>
